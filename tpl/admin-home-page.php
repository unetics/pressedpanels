...
Custom Home Page
		...
		<p><input type="submit" class="button button-primary" id="panels-save-home-page" value="Save Home Page" /></p>

		<?php wp_nonce_field('save', '_sopanels_home_nonce') ?>
	</form>
	<noscript><p>This interface requires Javascript</p></noscript>
</div> 